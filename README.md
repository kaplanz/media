...
A REST API for managing a personal media library. Tracks books, films, games,
links, and television shows. Records are stored in SQLite, served over HTTP with
optional bearer-token authentication, and documented via an auto-generated
...
A machine-readable OpenAPI spec is available at `/openapi.json`. The
